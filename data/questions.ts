...
export const questions: InternalQuestion[] = [
  ...
  { id: 17, question: "Pendidikan moral yang baik mendorong siswa untuk...", options: [{ id: "A", text: "Bertindak bertanggung jawab" }, { id: "B", text: "Menghindari semua perbedaan" }, { id: "C", text: "Memaksakan pendapat" }, { id: "D", text: "Mengutamakan kepentingan pribadi" }], correctAnswer: "A" },
