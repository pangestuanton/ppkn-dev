...
export default function QuizPage() {
  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-6 lg:px-20 py-4 select-none">
      {/* Top Header */}
      <div className="w-full flex flex-col gap-3 mb-8">
        <div className="flex items-center justify-between px-1">
          <div className="flex items-center gap-3">
            <span className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full bg-[#2a2a2a] text-[#FFD22A] font-['Quicksand'] font-bold text-sm shadow-[inset_0_2px_2px_rgba(255,255,255,0.15),0_4px_0_#0e0e0e]">
              <span className="w-2.5 h-2.5 rounded-full bg-[#FFD22A] shadow-[0_0_8px_#ffd22a]" />
              MORAL DEVELOPMENT
            </span>
            <span className="hidden sm:inline-flex items-center text-[#999079] font-['Quicksand'] font-semibold text-xs tracking-widest uppercase">
              • Teori Lawrence Kohlberg
            </span>
          </div>
          <div className="flex items-baseline gap-1 bg-[#1c1b1b] px-6 py-2 rounded-full shadow-[inset_0_3px_5px_rgba(0,0,0,0.8),0_4px_0_#0e0e0e]">
            <span className="font-['Bricolage_Grotesque'] font-extrabold text-2xl text-[#a6c8ff]" style={{ filter: "drop-shadow(0 2px 0 #005dad)" }}>
              {String(currentQuestionIndex + 1).padStart(2, "0")}
            </span>
            <span className="font-['Bricolage_Grotesque'] font-bold text-2xl text-[#4d4633]">/</span>
