...
export default function Footer() {
  return (
    <footer className="w-full bg-[#0e0e0e] py-6">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-20 flex flex-col sm:flex-row items-center justify-between gap-4 text-center sm:text-left text-[#d1c6ac] font-['Quicksand'] font-semibold text-xs">
        ...
        <div className="flex flex-wrap justify-center items-center gap-3 sm:gap-8">
          <span className="font-['Quicksand'] font-bold text-xs text-[#E6C750] uppercase">
            Milik {siteConfig.group}
          </span>
